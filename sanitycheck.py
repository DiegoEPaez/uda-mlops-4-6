...
def run_sanity_check(_test_dir):
    print(
    ...
    if not test_functions_for_post:
        ...
        print(
            ...
            + (
                ...
                "method. One test case for EACH "
                "of the possible inferences (results/outputs) "
                "of the ML model.\n"
            )
        )
        SANITY_TEST_PASSING = False
        ...
        if (
            ...
            print(
                ...
                "one for each possible prediction your model can make."
            )
